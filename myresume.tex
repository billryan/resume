...
% 添加意向岗位，求职意向
\section*{\faGraduationCap\ Skil}


\section{\faGraduationCap\ Education}
% =============================================education=================================
\subsection{\textbf{shanghai jiaotong daxue } \texorpdfstring{\hfill}{\space} wulixu \texorpdfstring{\hfill}{\space} boshi \texorpdfstring{\hfill}{\space} 2021-2008}
\subsection{\textbf{shanghai jiaotong daxue } \texorpdfstring{\hfill}{\space} wulixu \texorpdfstring{\hfill}{\space} boshi \texorpdfstring{\hfill}{\space} 2021-2008}
...
% using makecell package

\multirowcell{2}[0ex][r]{2021 \\*  2022 \\* }  %第一列 
% 第二列
& \textbf{cv}\\* 
& nlp \\* 
